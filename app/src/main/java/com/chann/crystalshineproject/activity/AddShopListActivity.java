...
public class AddShopListActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener{
    ...
    private void init() {
        ...
        ArrayAdapter adapter = new ArrayAdapter<String>(getBaseContext(), R.layout.spinner_item, categories);
